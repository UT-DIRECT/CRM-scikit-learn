...
def evaluate_linear_regression_model():
    ...
    for i in [0, 1, 2, 3, 4, 6]:
        ...
        bgr = MBBaggingRegressor(
            base_estimator=LinearRegression(), n_estimators=n_estimators,
        ...
        plt.scatter(t_test, y_test[:30], color='magenta', marker='x', label='True Value')
        ...
        plot_helper(
            FIG_DIR,
            title='{}: 30 Days Prediction Linear Regression'.format(name),
            xlabel='Days',
